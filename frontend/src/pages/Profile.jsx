	...
	return (
		<div className="py-6">
				...
				{children.map((child) => (
					...
					>
						...
						<Link
							...
							className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-xl focus:ring-4 focus:outline-none bg-gray-600 hover:text-gray-600 hover:bg-white hover:border-gray-600 hover:drop-shadow-xl
			...
			<div
				...
				className="bg-gray-800 overflow-hidden rounded-xl mx-5"
			>
				...
				<h2 id="accordion-collapse-heading-2 mx-5">
					<button
						type="button"
						className="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-500 dark:bg-gray-800 "
