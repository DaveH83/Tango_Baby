...
class ChildViewSet(viewsets.ModelViewSet):
  ...
  # For the rankings
  # add api view to get two random liked names
  # add ranking to the through table Voted_Names (bigInt) - use put method on the detail view to change ranking by row ID
